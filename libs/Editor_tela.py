...
def Editor_interface(screen, keys):
    ...
    # parte de movimentacao de imagem
    ...
    # desenha o botao de procurar cor
    ...
    # desenha o botal de cortar imagem
    if not keys['cut']:
    ...
    # posicao do mouse para a tela
    Text(screen, 'x:{}, y:{}'.format(keys['x_img_pos'], keys['y_img_pos']), keys['letter_color'], 20, keys['menu']+2, keys['parameters'].height*keys['parameters'].pix-20)